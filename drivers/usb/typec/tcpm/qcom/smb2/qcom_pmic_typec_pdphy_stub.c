						  ...
						  unsigned int negotiated_rev)
{
	...
	dev_warn_ratelimited(dev,
			     "rejecting PD transmit type %d while PD is disabled\n",
			     type);
...
int qcom_pmic_typec_smb2_pdphy_stub_probe(struct platform_device *pdev,
					  struct pmic_typec *tcpm)
{
	...
	tcpm->pdphy_quiesce = qcom_pmic_typec_pdphy_stub_stop;
